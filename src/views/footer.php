...
<<<<<<< HEAD
        ...
        <li class="nav-item"><a href="/bajorosario-shopping" class="nav-link px-2 text-body-secondary">Incio</a></li>
        ...
        <?php } else { ?>
            <li class="nav-item"><a href="/bajorosario-shopping/inicio_sesion" class="nav-link px-2 text-body-secondary">Iniciar sesión</a></li>
        <?php } ?>
        </ul>
    </div>
=======
...
>>>>>>> 07556f59136a5a7174bb9fb9910f97f4055282e9
    </div>
</footer>
