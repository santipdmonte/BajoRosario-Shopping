...
<body>
    ...
    <div class="container" style="align: center; width: 60%;">
        <form action="procesar_edicion_novedad.php" method="POST" style="margin: 0 auto; width: 50%;">
            ...
            <input type="text" name="texto_novedad" rows="4" cols="50" style="width: 100%; height: 60px; font-size: 20px;" value="<?php echo $texto_novedad; ?>"></input><br>

            <label style="text-align: left; font-weight: bold; font-size: 18px;">Fecha Desde:</label><br>
            <input type="date" name="fecha_desde" style="width: 30%; height: 60px; font-size: 20px; text-align: left;" value="<?php echo $fecha_desde; ?>"><br>

            <label style="text-align: left; font-weight: bold; font-size: 18px;">Fecha Hasta:</label><br>
            <input type="date" name="fecha_hasta" style="width: 30%; height: 60px; font-size: 20px; text-align: left;" value="<?php echo $fecha_hasta; ?>"><br>

            <label style="text-align: left; font-weight: bold; font-size: 18px;">Categoría Cliente:</label><br>
        
            <select name="categoria_cliente" style="width: 30%; height: 60px; font-size: 20px; text-align: left;" value="<?php echo $categoria_cliente; ?>">
            ...
            <br>
            <input type="submit" name="edit_novedad" value="Guardar Cambios" style="background-color: #4CAF50; color: white; padding: 10px 25px; border: none; cursor: pointer;">
        </form>
    </div>
</body>
</html>
